...
function my_acf_settings_dir( $dir ) {
	   // update path
    $dir = get_template_directory_uri() . '/includes/plugins/acf/';
    // return
    return $dir;
}
...
// 4. Include ACF
include_once( get_template_directory() . '/includes/plugins/acf/acf.php' );
...
if (!function_exists('tuto_widgets_init')) {
	function tuto_widgets_init() {
		...
		register_sidebar(array('name' => sprintf(esc_html_x('Footer %d - 1/4 Width', 'widget area name', 'tuto'), 1), 'id' => 'footer-1', 'description' => esc_html__('Widget area in footer.', 'tuto'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s"><div class="mh-widget-inner">', 'after_widget' => '</div></div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
		register_sidebar(array('name' => sprintf(esc_html_x('Footer %d - 1/4 Width', 'widget area name', 'tuto'), 2), 'id' => 'footer-2', 'description' => esc_html__('Widget area in footer.', 'tuto'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s"><div class="mh-widget-inner">', 'after_widget' => '</div></div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
		register_sidebar(array('name' => sprintf(esc_html_x('Footer %d - 1/4 Width', 'widget area name', 'tuto'), 3), 'id' => 'footer-3', 'description' => esc_html__('Widget area in footer.', 'tuto'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s"><div class="mh-widget-inner">', 'after_widget' => '</div></div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
		register_sidebar(array('name' => sprintf(esc_html_x('Footer %d - 1/4 Width', 'widget area name', 'tuto'), 3), 'id' => 'footer-4', 'description' => esc_html__('Widget area in footer.', 'tuto'), 'before_widget' => '<div id="%1$s" class="mh-footer-widget %2$s"><div class="mh-widget-inner">', 'after_widget' => '</div></div>', 'before_title' => '<h6 class="mh-widget-title mh-footer-widget-title"><span class="mh-widget-title-inner mh-footer-widget-title-inner">', 'after_title' => '</span></h6>'));
	}
}
